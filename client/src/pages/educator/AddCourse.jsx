      ...
      <form  onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <input  onChange={e => setDiscount(e.target.value)}
           value = {discount} type="number" placeholder='0' min={0} max={100}
          ...
          {chapters.map((chapter,chapterIndex) => (
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                ...
                className='cursor-pointer' onClick={() => handleChapter('remove', chapter.chapterId)}/>
              </div>
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture,lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - { lecture.lectureDuration} mins -
                        ...
                        className='text-blue-500'>Link</a> - {lecture.isPreviewFree ?
            ...
            showPopup && (
              ...
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                  ...
                  onClick={addLecture}>
                    ...
                    alt=""className='absolute top-4 right-4 w-4 cursor-pointer'
                    />
              </div>
              </div>
            )
