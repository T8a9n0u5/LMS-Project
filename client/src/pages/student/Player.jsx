                              ...
                              <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                                ...
                                (
                                  <li key={i} className='flex items-start gap-2 py-1'>
                                    <img src={progressData && progressData.lectureCompleted.includes(lecturewhat.lectureId) ? assets.blue_tick_icon: assets.play_icon} alt="play icon" className='w-4 h-4 mt-1' />
